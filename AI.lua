--[[
    ...
    All homunculus/mercenary AI begins with a file named AI.lua/AI_M.lua. This file is
    loaded by the Ragnarok Online client at runtime, and several times per second the
    function named `AI(id)` is called to perform AI functionality.
